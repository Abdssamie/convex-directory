...
async function getAllBenefits(organizationId) {
...
async function ensureBenefitIds(spec, organizationId, benefitIdsByDescription) {
  const benefitIds = [];
...
function buildCreatePrice(spec) {
...
function buildUpdatedPrices(product, spec) {
