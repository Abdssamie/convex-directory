...
const PLAN_SPECS: PlanSpec[] = [
  {
    ...
    plan: "free",
    interval: "month",
    name: "Convex Hub Free",
    description: "Start free with core Convex Hub boilerplate access.",
    amountType: "free",
  ...
  },
  {
    ...
    plan: "business",
    interval: "month",
    name: "Convex Hub Business Monthly",
  ...
  },
  {
    ...
    plan: "business",
    interval: "year",
    name: "Convex Hub Business Yearly",
