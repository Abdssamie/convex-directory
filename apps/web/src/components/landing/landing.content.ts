...
export default {
  ...
  content: {
    ...
    navbar: {
      ...
      title: t({ en: "Convex Directory", fr: "Répertoire Convex" }),
    ...
    directory: {
      ...
      categoriesDescription: t({
        en: "Discover innovative products organized by category. Browse to find the latest launches in areas that interest you most.",
        fr: "Découvrez des produits innovants organisés par catégorie. Parcourez pour trouver les derniers lancements dans les domaines qui vous intéressent le plus.",
      }),
