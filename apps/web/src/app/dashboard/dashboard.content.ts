...
const dashboardDictionary = {
  ...
  content: {
    page: {
      ...
      description: t({ en: "Welcome to your admin dashboard", fr: "Bienvenue sur votre tableau de bord administrateur" }),
    },
    organizationOverview: {
      loadingTitle: t({ en: "Organization", fr: "Organisation" }),
      loadingDesc: t({ en: "Loading workspace details.", fr: "Chargement des détails de l'espace de travail." }),
      noActiveTitle: t({ en: "No active organization", fr: "Aucune organisation active" }),
      noActiveDesc: t({ en: "Create your first workspace or switch to one you already joined.", fr: "Créez votre premier espace de travail ou rejoignez-en un." }),
      createOrg: t({ en: "Create organization", fr: "Créer une organisation" }),
      chooseExisting: t({ en: "Choose existing workspace", fr: "Choisir un espace de travail existant" }),
      activeWorkspaceDesc: t({ en: "Active workspace for dashboard, members, and invitations.", fr: "Espace de travail actif pour le tableau de bord, les membres et les invitations." }),
    ...
    sectionCards: {
      ...
      visitorsLast6Months: t({ en: "Visitors for the last 6 months", fr: "Visiteurs sur les 6 derniers mois" }),
      ...
      acquisitionNeedsAttention: t({ en: "Acquisition needs attention", fr: "L'acquisition nécessite de l'attention" }),
      activeAccounts: t({ en: "Active Accounts", fr: "Comptes Actifs" }),
      strongUserRetention: t({ en: "Strong user retention", fr: "Forte rétention des utilisateurs" }),
      engagementExceedTargets: t({ en: "Engagement exceed targets", fr: "L'engagement dépasse les objectifs" }),
      growthRate: t({ en: "Growth Rate", fr: "Taux de Croissance" }),
      steadyPerformanceIncrease: t({ en: "Steady performance increase", fr: "Augmentation régulière des performances" }),
      meetsGrowthProjections: t({ en: "Meets growth projections", fr: "Atteint les projections de croissance" }),
    },
    chartAreaInteractive: {
      totalVisitors: t({ en: "Total Visitors", fr: "Visiteurs Totaux" }),
      totalLast3Months: t({ en: "Total for the last 3 months", fr: "Total pour les 3 derniers mois" }),
